...
def dashboard():
    ...
    for signal in signals[:20]:
        ...
        <tr>
            ...
            <button onclick="sendAction('{validation["trace_id"]}','ESCALATE','{signal["signal_id"]}','{analysis["risk_level"]}','{analysis["anomaly_type"]}')">
            Escalate
            </button>

            <button onclick="sendAction('{validation["trace_id"]}','REVIEW','{signal["signal_id"]}','{analysis["risk_level"]}','{analysis["anomaly_type"]}')">
            Review
            </button>

            <button onclick="sendAction('{validation["trace_id"]}','ASSIGN','{signal["signal_id"]}','{analysis["risk_level"]}','{analysis["anomaly_type"]}')">
            Assign
            </button>
